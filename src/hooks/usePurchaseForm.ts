...
import { PurchaseFormData, TransactionItem, CostSummary } from '@/types/transaction';
...
export const usePurchaseForm = () => {
  ...
  const updateFormData = useCallback((
    section: 'supplier' | 'transaction',
    data: Partial<PurchaseFormData['supplier']> | Partial<PurchaseFormData['transaction']>
  ) => {
    setFormData(prev => ({
      ...prev,
  ...
  }, [formData.supplier, formData.transaction.date]);
